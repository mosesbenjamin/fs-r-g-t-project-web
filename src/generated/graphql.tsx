...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', id: number, createdAt: any, title: string, updatedAt: any, text: string, points: number, creatorId: number } };
